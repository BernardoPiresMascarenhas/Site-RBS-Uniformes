...
export function VisitModal() {
  ...
  return (
    <>
      ...
      {open ? (
        <div
          // No desktop o diálogo é ancorado no topo com uma folga fixa (em vez
          // de centralizado), para ficar sempre bem abaixo da navbar fixa.
          className="fixed inset-0 z-[60] flex items-end justify-center bg-black/80 backdrop-blur-sm sm:items-start sm:px-6 sm:pb-10 sm:pt-44 lg:pt-52"
        ...
        >
          <div
            ...
            // no desktop a altura é a viewport menos a folga do topo, para o
            // diálogo aproveitar o espaço disponível mesmo em telas baixas
            className="flex max-h-[88svh] w-full animate-fade-up flex-col overflow-hidden rounded-t-brand-lg border border-premium-gold/35 bg-premium-black text-left shadow-brand-lg sm:max-h-[calc(100svh-16rem)] sm:max-w-xl sm:rounded-brand"
          >
